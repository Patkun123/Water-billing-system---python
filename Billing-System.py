...
class Bill_App:
    def __init__(self,root):
        ...
        title=Label(self.root,text="Water Billing System",bd=15,relief=RIDGE,font=("Arial Black",20),bg="#000000",fg="white").pack(fill=X)
        #===================================variables=======================================================================================
        self.nutella=IntVar()
        self.noodles=IntVar()
        self.lays=IntVar()
        ...
        details=LabelFrame(self.root,text="Customer Details",font=("Arial Black",15),bg="#444444",fg="white",relief=GROOVE,bd=10)
        details.place(x=0,y=80,relwidth=1)
        cust_name=Label(details,text="Customer Name",font=("Arial Black",15),bg="#000000",fg="white").grid(row=0,column=0,padx=15)
        
        cust_entry=Entry(details,borderwidth=10,width=50,textvariable=self.c_name).grid(row=0,column=1,padx=8)
        
        contact_name=Label(details,text="Contact No.",font=("Arial Black",15),bg="#000000",fg="white").grid(row=0,column=2,padx=10)
        
        contact_entry=Entry(details,borderwidth=10,width=50,textvariable=self.phone).grid(row=0,column=3,padx=8)
        ...
        #=====================================================billarea==============================================================================
        billarea=Frame(self.root,bd=10,relief=GROOVE,bg="#444444")
        billarea.place(x=1190,y=160,width=350,height=528)
        
        bill_title=Label(billarea,text="Bill Reciept",font=("Arial Black",17),bd=7,relief=GROOVE,bg="#000000",fg="#ffffff").pack(fill=X)
        ...
        #=================================================billing menu=========================================================================================
        billing_menu=LabelFrame(self.root,text="Billing Summery",font=("Arial Black",20),relief=GROOVE,bd=10,bg="#444444",fg="white")
        billing_menu.place(x=0,y=690,relwidth=1,height=170)
        
        total_snacks=Label(billing_menu,text="Total Snacks Price",font=("Arial Black",11),bg="#000000",fg="white").grid(row=0,column=0)
        ...
        total_grocery=Label(billing_menu,text="Total Grocery Price",font=("Arial Black",11),bg="#000000",fg="white").grid(row=1,column=0)
        ...
        total_hygine=Label(billing_menu,text="Total Beauty & Hygine Price",font=("Arial Black",11),bg="#000000",fg="white").grid(row=2,column=0)
        ...
        tax_snacks=Label(billing_menu,text="Snacks Tax",font=("Arial Black",11),bg="#000000",fg="white").grid(row=0,column=2)
        tax_snacks_entry=Entry(billing_menu,width=30,borderwidth=2,textvariable=self.a).grid(row=0,column=3,padx=10,pady=7)
        
        tax_grocery=Label(billing_menu,text="Grocery Tax",font=("Arial Black",11),bg="#000000",fg="white").grid(row=1,column=2)
        tax_grocery_entry=Entry(billing_menu,width=30,borderwidth=2,textvariable=self.b).grid(row=1,column=3,padx=10,pady=7)

        
        tax_hygine=Label(billing_menu,text="Beauty & Hygine Tax",font=("Arial Black",11),bg="#000000",fg="white").grid(row=2,column=2)
...
def total(self):
    ...
    total_snacks_price=(
                ...
                self.si+
                self.na)          
    self.total_sna.set(str(total_snacks_price)+" Pesos")
    self.a.set(str(round(total_snacks_price*0.05,3))+" Pesos")
